...
\caption{\label{fig:fig1}\footnotesize {\it Left:} neutrino yields for the SNS mercury and
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=6.in]{table.pdf}
\caption{\label{fig:figx} \footnotesize 
