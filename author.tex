...
\author[k]{\small N. Lopez-March,}

\author[j]{\small J. Mart\'in-Albo,}

\author[d]{\small J. Mu\~noz-Vidal,}

\author[j]{\small P. Novella,}
...
\author[k]{\small J. Rodriguez,}

\author[j]{\small B. Rubio,}

\author[n]{\small A. Tarife\~no-Saldivia,}
...
\affiliation[m]{\footnotesize Universitat Politecnica de Catalunya, UPC, Intstitut de Tecniques Energetiques (INTE). Av. Diagonal 647, Barcelona, Spain}
